...
\doublespacing 
 ...
 \maketitle
  ...
  \paragraph{}       % JD: This is not the proper use of \paragraph.  Just add a blank line.
...
% JD: Also, don't forget that LaTeX quotes should be done as `` and ''.
...
% JD: Actually, this is a pretty narrow definition of "second screen."
%     It happens to be merely the latest version of the idea.  The intent
%     of the question was to explore the broader issue of multiple displays.
%
%     In any case, let's see what you do with the idea, even with this newer, narrower definition.
 \section{Background}
 \paragraph{}
