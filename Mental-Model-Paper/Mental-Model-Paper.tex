...
% JD2: You probably want to rephrase the above sentence.  The way it reads,
%      it sounds like any new user interface is unavoidably error-prone.
%      That does not have to be the case, and besides, I don't think that
%      is war you actually meant.
...
% JD2: That last error scenario is nice and well-chosen.
...
% JD2: I don't see how "consistency of data display" applies here.  The early
%      point in this paragraph is how a second screen takes away the user's
%      attention from the primary screen.  How does "consistency of data display"
%      address that division of attention?  A screenshot or sketch sounds particularly
%      appropriate here.
 ...
 Moreover, let us summarize Second Screen in terms of metrics.  Yes we answered so many questions that point out the answers to most of the metrics introduced by "Nielsen". % JD2: You're citing more here; may as well cite this one too.
% JD2: "Most of the metrics????"  So far you have only addressed one: errors.
...
% JD2: The claim in the last sentence is unsubstantiated.
...
% JD2: Good sources and background here.
 ...
 First I want to mention the guideline, "Flexibility for User Control of Data Display" and how Second Screens applications met this particular guideline introduced by (Smith and Mosier 1986). % JD2: Why is this not a \cite?
...
% JD2: The above paragraph is in need of an illustration or two.
...
% JD2: The sentence above is what was missing from your Assignment 0926.
