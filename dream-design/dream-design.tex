...
\includegraphics[scale=0.6]{../../../Downloads/photo41.jpg}
...
% JD2: OK, yes, *this* is the discussion that is intended by this assignment.
%      The words are fairly descriptive, but you know what's missing, right?
%      Some sketch of what you are describing, visually, would go a long way
...
% JD2: I can recognize that some of your choices are based on certain principles
%      that have been mentioned in class, but...you need to mention them by name,
%      per the terminology we use.  Otherwise, there is no clear indication that
%      you *did* consciously think about your design in terms of those principles.
...
\label{overflow}
\end{figure}
% JD2: At least you have *a* picture, if not *the* picture that you are
%      writing out.  I can see how this is related, but the 3D aspect is
%      a major difference and that is really the part that demands some
...
% JD2: You're misapplying the Smith and Mosier guideline here.  Note that
%      this guideline document was written before direct manipulation
%      became prevalent (1986!).  Therefore, "input actions" does not
%      cover mouse movement or other continuous gestures; the context of
%      this guideline is more keyboard-based.

In the following we will be mentioning a good interface design principles, and show how my dream interfaces should accommodate them.  First of all, there are golden rules for a good interface, presented by "Shneiderman." % JD2: This needs a proper citation.
...
% JD2: Thank you, I was waiting for you to use the term.
...
% JD2: Oops, this image is in the wrong place.  Move it into dream-design/
%      also so that it can be committed.
\includegraphics[scale= 0.135]{../../../Downloads/VIUscan_handheld_3D_scanner_in_use.jpg}
